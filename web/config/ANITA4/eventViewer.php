				...
				$.each(runs, function(run, pngs) {
					...
					$.each(pngs[0], function(eventKey,eventValue) {
						...
						/*$.each(eventValue, function(key,value) {
							var png = value.png;
							var name = value.png.replace("output/ANITA4/event/all/run"+runNum+"/"+eventKey+"/event_","").replace(".png","");
...
<div id="screen">
	<img id="img" src="http://www.hep.ucl.ac.uk/uhen/anita/chris/aware/aware/web/output/ANITA4/event/all/run10583/ev11242000/event_11242642.png" width="1196px" height="772px">
</div>
<div id="controls">
